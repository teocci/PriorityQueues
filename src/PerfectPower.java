...
/**
 *  The {@code Multiway} class prints out all perfect powers that can be represented as 64-bit long
 *  integers: 4, 8, 9, 16, 25, 27, ... A perfect power is a number that can be written as ab for
 *  integers a and b ≥ 2.
 *  <p>
